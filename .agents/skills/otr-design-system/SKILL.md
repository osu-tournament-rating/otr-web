...
Read [the interface references](../../design/README.md) and the affected app's
`AGENTS.md`. Use the current code to establish behavior and the named reference
patterns to establish the intended design. Inspect the relevant local rendering.
