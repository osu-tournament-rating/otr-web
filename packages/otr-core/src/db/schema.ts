...
export const gameScores = pgTable(
  'game_scores',
  {
    ...
    placement: integer().default(0).notNull(),
    ...
    pass: boolean().default(false).notNull(),
    isPerfectCombo: boolean('is_perfect_combo').default(false).notNull(),
    legacyPerfect: boolean('legacy_perfect').default(false).notNull(),
    grade: integer().default(0).notNull(),
    mods: integer().default(0).notNull(),
    ...
    legacyTotalScore: integer('legacy_total_score').default(0).notNull(),
    team: integer().default(0).notNull(),
    ruleset: integer().default(0).notNull(),
