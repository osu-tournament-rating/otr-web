...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        'group/list max-h-[300px] min-h-0 scroll-py-1 overflow-y-auto overflow-x-hidden',
        className
      )}
      {...props}
    />
