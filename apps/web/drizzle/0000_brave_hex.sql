-- This migration creates the initial database.
-- Uncomment this file to do so. If you are upgrading an existing
-- database, leave this file alone.
...
-- CREATE INDEX "ix_game_audits_action_user_id_created" ON "game_audits" USING btree ("action_user_id" int4_ops,"created" timestamptz_ops);--> statement-breakpoint
...
-- CREATE UNIQUE INDEX "ix_game_rosters_game_id_roster" ON "game_rosters" USING btree ("game_id" int4_ops,"roster" array_ops);--> statement-breakpoint
...
-- CREATE INDEX "ix_game_score_audits_action_user_id_created" ON "game_score_audits" USING btree ("action_user_id" int4_ops,"created" timestamptz_ops);--> statement-breakpoint
...
-- CREATE INDEX "ix_match_audits_action_user_id_created" ON "match_audits" USING btree ("action_user_id" int4_ops,"created" timestamptz_ops);--> statement-breakpoint
...
-- CREATE UNIQUE INDEX "ix_match_rosters_match_id_roster" ON "match_rosters" USING btree ("match_id" int4_ops,"roster" array_ops);--> statement-breakpoint
...
-- CREATE INDEX "ix_player_match_stats_player_id_won" ON "player_match_stats" USING btree ("player_id" int4_ops,"won" bool_ops);--> statement-breakpoint
...
-- CREATE INDEX "ix_player_ratings_ruleset_rating" ON "player_ratings" USING btree ("ruleset" int4_ops,"rating" float8_ops);--> statement-breakpoint
...
-- CREATE INDEX "ix_tournament_audits_action_user_id_created" ON "tournament_audits" USING btree ("action_user_id" int4_ops,"created" timestamptz_ops);--> statement-breakpoint
