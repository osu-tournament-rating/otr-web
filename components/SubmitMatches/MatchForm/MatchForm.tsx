      ...
      <Form action={formAction}>
          ...
          <div className={styles.fields}>
            <div className={styles.row}>
              <div className={styles.field}>
                ...
                <span className={styles.inputError}>{state?.errors?.mode}</span>
            ...
            <div className={styles.row}>
              ...
              <div className={styles.field} id={styles.tournamentAbbreviation}>
                ...
                <label htmlFor="teamSize">
                  ...
                  <InfoIcon>
                    <p>
                      ...
                      tournament and 1 for a 1v1. Remember not to include battle
                      royale matches or matches that are played in head-to-head
        ...
        <div className={styles.section}>
          ...
          <div className={styles.fields}>
            <div className={styles.row}>
              <div className={styles.field}>
                <span className={styles.inputError}>{state?.errors?.ids}</span>
                <textarea
                  required={true}
                  name="matchLinks"
                  id="matchLinks"
            ...
            {(userRoles.includes('MatchVerifier') ||
              ...
              <div className={clsx(styles.row, styles.checkbox)}>
                <input
                  ...
                  id="verifierCheckBox"
                  /* defaultChecked={verifierAccepted} */
